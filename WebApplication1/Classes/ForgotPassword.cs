    ...
    public class ForgotPassword
    {
        ...
        public int request(string email)
        {
            ...
            else
            {
                ...
                //string RegUrl = "ForgotPassword/Recover/" + VCode;
                ...
                //MailAddress m = new MailAddress("no-reply@farhade.com");

                //mail.From = m;

                //SmtpClient sc = new SmtpClient();
                //sc.Host = "mail.farhade.com";

                //sc.Port = 25;

                //sc.EnableSsl = false;

                //NetworkCredential c = new NetworkCredential("test@farhade.com", "oj8m3G3_");
