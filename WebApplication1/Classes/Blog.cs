...
namespace WebApplication1.Classes
{
    public class Blog
    {
        ...
        public DataTable blogEntries()
        {
            ...
            SqlDataAdapter sda1 = new SqlDataAdapter("sp_blog", sqlConn3);
        ...
        public Tuple<int, DataTable, DataTable, DataTable> blogEntryInfo(int entryId)
        {
            int status = 0;
            ...
            return new Tuple<int, DataTable, DataTable, DataTable>(status, dt, dtPervious, dtNext);
        }
    }
}