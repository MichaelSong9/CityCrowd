<%@ Page Title="Add Event" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="EventsAdd.aspx.cs" Inherits="WebApplication1.EventsAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="nHeader">
        ...
        <div class="nPageTitle">Add Event</div>
    ...
    <div class="nAEPage hidden">
        ...
        <div class="nEAContentHolder">
            ...
            <div class="clear"></div>
            <input class="nEADurationSlider slider-fill" type="range" name="slider-fill" value="" min="0" max="100" data-highlight="true" />
            <!--
            <div class="nTimeTypeContainer">
                <input type="radio" name="timeType" value="male" class="nTimeType" />
                <div class="nTimeTypeLabel">Unknown</div>
            </div>
            
            <div class="nTimeTypeContainer nTimeTypeContainerUnknown" time-type="Unknown">
                <!--<input type="radio" name="timeType" value="Hour" class="nTimeType" />
                <div class="nRadioCircle"></div>
                <div class="nTimeTypeLabel">Unknown</div>
            </div>
            <div class="nTimeTypeContainer nTimeTypeContainerHours" time-type="Hours">
                <!--<input type="radio" name="timeType" value="Day" class="nTimeType" />
                <div class="nRadioCircle"></div>
                <div class="nTimeTypeLabel nTimeTypeLabelDays">Hour</div>
            </div>
            <div class="nTimeTypeContainer nTimeTypeContainerDays" time-type="Days">
                <!--<input type="radio" name="timeType" value="Day" class="nTimeType" />
                <div class="nRadioCircle"></div>
                <div class="nTimeTypeLabel nTimeTypeLabelDays">Day</div>
            </div>
        </div>
        -->
    </div>
    ...
    <div class="invisible">
        <asp:Panel ID="PanelInfo" runat="server">
            ...
            </asp:DropDownList><asp:DropDownList ID="DropDownListTimeHour" runat="server">
            ...
            <asp:Label ID="LabelTime" runat="server" AssociatedControlID="DropDownListTimeHour" Text="When:"></asp:Label>
            ...
            <asp:Label ID="LabelLocation" runat="server" Text="Where:"></asp:Label>

            <asp:Label ID="LabelDescriptions" runat="server" Text="Description:" AssociatedControlID="TextBoxDescriptions"></asp:Label>

            <asp:Label ID="LabelActivity" runat="server" AssociatedControlID="DropDownListActivity" Text="Activity:"></asp:Label>
            <asp:DropDownList ID="DropDownListActivity" runat="server">
                <asp:ListItem Value="1">Dancing</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="LabelMood" runat="server" AssociatedControlID="DropDownListMood" Text="Mood:"></asp:Label>
            ...
            <asp:Label ID="LabelPrivacy" runat="server" AssociatedControlID="DropDownListPrivacy" Text="Privacy:"></asp:Label>

            <asp:Button ID="ButtonSubmit" runat="server" OnClick="ButtonSubmit_Click" Text="Add" />
    ...
    <asp:HiddenField ID="HiddenFieldDurationType" runat="server" />
</asp:Content>
