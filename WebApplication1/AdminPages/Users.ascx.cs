...
namespace WebApplication1.AdminPages
{
    public partial class Users : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!ap.getAdminPremissions(Convert.ToInt32(Session["UserId"]), "Users"))
            {
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                LabelLastLocation.Text = dt.Rows[0]["LastLocation"].ToString();
                LabelLocationDetect.Text = dt.Rows[0]["LocationDetect"].ToString();
                ...
                // location detect
                if (dt.Rows[0]["LocationDetect"].ToString() == "True")
                {
                    LabelLocationDetect.Text = "Yes";
                }
                else
                {
                    LabelLocationDetect.Text = "No";
                }
                // Rate
                ...
                {
                    ImagePhoto.ImageUrl = "~/Files/ProfilesPhotos/" + Page.RouteData.Values["Id"] + "-220.jpg";
                }
                else
                {
                    ImagePhoto.ImageUrl = "~/Images/ProfilesPhotos/nophoto220.png";
                }
            }
        }
