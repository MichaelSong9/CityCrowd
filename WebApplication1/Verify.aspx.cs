                ...
                case "Email":
                    {
                        ...
                        //{
                            ...
                            sda.SelectCommand.Parameters["@VCode"].Value = Page.RouteData.Values["Code"];
                            sda.Fill(ds);
                            dt = ds.Tables[0];
                            ...
                            if (dt.Rows.Count != 0)
                            {
                                if (dt.Rows[0]["VerificationStatus"].ToString() == "1")
                                {
                                    ...
                                    LabelMessage.Text = "You have successfull verified your email address.";
                                }
                                else
                                {
                                    //unsuccessfull
                                    LabelMessage.Visible = true;
                                    LabelMessage.Text = "Verification of your email address was not successfull!";
                                }
                            }
                            else
                            {
